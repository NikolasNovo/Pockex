...
const translations = {
  en: {
    "meta.title": "Pockex - cash register and exchange in one screen",
    "meta.description": "Pockex - a cash register and accounting for exchange operations: rates, trades, clients, and balances in one interface.",
    ...
    "hero.eyebrow": "Pockex · cash register & exchange",
    ...
    "footer.tagline": "Cash register and exchange in one interface.",
